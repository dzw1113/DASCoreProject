 ...
 * @update
 */
public class SavePaidTotalAmountPaidFun extends AbstractRedisConnFun {

	private static final long serialVersionUID = -4218087641817062563L;

	public SavePaidTotalAmountPaidFun(JedisPoolConfig poolConfig) {
		super(poolConfig);
	}
	...
	public void execute(TridentTuple tuple, TridentCollector collector) {
		...
		// Float paidTotalAmount = tuple.getFloat(1);
