 ...
 * @update
 */
public class SaveAnnualReceivedAmountFun extends AbstractRedisConnFun {

	private static final long serialVersionUID = -4218087641817062563L;

	public SaveAnnualReceivedAmountFun(JedisPoolConfig poolConfig) {
		super(poolConfig);
	}
	...
	public void execute(TridentTuple tuple, TridentCollector collector) {
		...
		// Double annualReceivedAmount = tuple.getDouble(1);
		...
		mapNk.put("year", arr[2]);
		mapNk.put("year", arr[3]);
		mapNk.put("annualReceivedAmount", "" + ob);
