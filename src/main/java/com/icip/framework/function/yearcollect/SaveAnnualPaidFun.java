 ...
 * @update
 */
public class SaveAnnualPaidFun extends AbstractRedisConnFun {

	private static final long serialVersionUID = -4218087641817062563L;

	public SaveAnnualPaidFun(JedisPoolConfig poolConfig) {
		super(poolConfig);
	}
...
//		Double annualPaid = tuple.getDouble(1);
